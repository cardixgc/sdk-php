...
/**
     ...
     * @return void
     */
    public function refundPayment($order_id, $order_payment_id, string $contentType = self::contentTypes['refundPayment'][0])
    {
        $this->refundPaymentWithHttpInfo($order_id, $order_payment_id, $contentType);
    }
     ...
     */
    public function refundPaymentWithHttpInfo($order_id, $order_payment_id, string $contentType = self::contentTypes['refundPayment'][0])
    {
        $request = $this->refundPaymentRequest($order_id, $order_payment_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refundPaymentAsync($order_id, $order_payment_id, string $contentType = self::contentTypes['refundPayment'][0])
    {
        return $this->refundPaymentAsyncWithHttpInfo($order_id, $order_payment_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refundPaymentAsyncWithHttpInfo($order_id, $order_payment_id, string $contentType = self::contentTypes['refundPayment'][0])
    {
        $returnType = '';
        $request = $this->refundPaymentRequest($order_id, $order_payment_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function refundPaymentRequest($order_id, $order_payment_id, string $contentType = self::contentTypes['refundPayment'][0])
    {

        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_id when calling refundPayment'
            );
        }
        ...
        if ($order_payment_id === null || (is_array($order_payment_id) && count($order_payment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_payment_id when calling refundPayment'
            );
        }
